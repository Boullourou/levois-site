...
| Adresse publique ou masquée | Aucune adresse de Mouaad sur LEVOIS. | Une notice BODACC publique contient une adresse, tandis que l’API entreprises masque l’adresse courante ; aucune adresse d’accueil du public n’est vérifiée ni autorisée à publication pour ce dossier. | **À FOURNIR PAR MOUAAD** pour toute publication ou fiche locale. | **CRITIQUE** pour vie privée et GBP : une adresse déclarative ne prouve ni accueil, ni enseigne, ni droit de publication. | Ne publier aucune adresse et conserver l’adresse masquée. | Réponse privée oui/non sur l’accueil physique ; si oui, adresse autorisée, preuve d’enseigne, accueil permanent et présence aux horaires. |
| Téléphone | `07 81 38 01 21`. | LEVOIS et profil officiel SAFTI concordent. | **VÉRIFIÉ publiquement** | Moyen si la ligne n’est plus contrôlée. | Conserver. | Confirmation que la ligne est professionnelle, contrôlée et accepte appels/SMS publics. |
| Email | `mouaad@levois.fr`. | LEVOIS uniquement : `src/config/site.ts:7` et `/contact`. | **À FOURNIR PAR MOUAAD** | Moyen : perte de leads/boîte non suivie. | Conserver après test opérationnel. | Confirmation de propriété + test réel envoi/réception/réponse + choix face à une éventuelle adresse SAFTI. |
| Réception physique | Non précisée ; le mot « rendez-vous » ne prouve pas un accueil sur place. | Aucune preuve publique. | **À FOURNIR PAR MOUAAD** | **CRITIQUE** pour adresse, horaires et GBP. | « Sur rendez-vous » seulement si exact, sans lieu. | Réponse oui/non. Si oui : enseigne, accueil réel, présence aux horaires. Si non : fiche de zone desservie, adresse masquée. |
...
| Formulation Google Business Profile | État de la fiche non accessible de manière probante. | Aucun lien direct/capture fourni ; E4. | **À FOURNIR PAR MOUAAD** | **CRITIQUE** : doublon, suspension, adresse personnelle, mauvais nom/catégorie. | Ne pas créer, dupliquer ou renommer la fiche en Phase 1. L’accueil peut employer uniquement le noyau factuel **VÉRIFIÉ** du §0 ; la relation de marque reste explicitement provisoire. | Lien Maps direct, place ID, statut de validation, propriétaire principal, nom exact, catégories, téléphone, site, adresse visible/masquée, zones, horaires, services, photos et avis. |
...
- Si Mouaad ne reçoit pas de clients à une adresse professionnelle permanente, l’adresse doit rester masquée et la fiche doit fonctionner en zone desservie.
- Si des clients sont reçus, Mouaad doit pouvoir prouver l’enseigne, l’accueil réel et la présence pendant les horaires publiés.
