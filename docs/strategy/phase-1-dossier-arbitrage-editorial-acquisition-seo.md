...
| Agent commercial | « EI - Agent commercial - 824 194 419 RSAC CHARTRES ». | Profil officiel SAFTI de Mouaad, consulté le 30 août 2026. | **VÉRIFIÉ** pour les mentions juridiques. | Élevé si cette qualité est transformée en « agent immobilier » ou utilisée comme accroche ordinaire. | **Mouaad Boullourou, entrepreneur individuel, agent commercial immatriculé au RSAC de Chartres sous le numéro 824 194 419.** Réserver cette formulation aux mentions juridiques. | Attestation RNE récente à archiver pour le dossier permanent de preuve. |
| RSAC | `824 194 419 RSAC CHARTRES`. | Profil officiel SAFTI de Mouaad, consulté le 30 août 2026. | **VÉRIFIÉ** ; distinct du SIRET. | Faible si le numéro, le registre et le greffe restent associés exactement. | **RSAC de Chartres 824 194 419** dans les mentions juridiques. | Attestation RNE récente à archiver ; ne pas déduire le SIRET du numéro RSAC. |
