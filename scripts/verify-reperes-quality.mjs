...
}finally{await browser.close();await fs.writeFile('artifacts/perspective/quality.json',JSON.stringify(result,null,2));console.log(JSON.stringify(result,null,2));}
